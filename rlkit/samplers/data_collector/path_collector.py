...
class MdpPathCollector(PathCollector):
    def __init__(
        ...
        self._curl_crop = curl_crop 
        self._curl_crop_output_size =curl_crop_output_size
        
        # for SLAC
        self._slac_algo = slac_algo
        self._slac_policy_input_type = slac_policy_input_type
        self._slac_obs_reset_w_same_obs = slac_obs_reset_w_same_obs
        self._generalization_test = generalization_test
    def collect_new_paths(
        ...
        while num_steps_collected < num_steps:
            ...
            path = self._rollout_fn(
                ...
                curl_crop = self._curl_crop,
                curl_crop_output_size = self._curl_crop_output_size,
                slac_algo = self._slac_algo,
                slac_policy_input_type = self._slac_policy_input_type,
                slac_obs_reset_w_same_obs = self._slac_obs_reset_w_same_obs,
                generalization_test = self._generalization_test,
